...
public class A3  extends JFrame {
	...
	class AddListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (node instanceof NestedShape) {
				NestedShape newNode = (NestedShape) node;
				panel.model.addShapeNode(newNode); 
			} else if (node == null) {
	...
	class TreeNodeSelectionListener implements TreeSelectionListener {
		...
		public void valueChanged(TreeSelectionEvent e) {
			...
			if (node instanceof NestedShape) {
				NestedShape ns = (NestedShape) node;
				panel.model.reload(ns); 
			}
		}
	}
